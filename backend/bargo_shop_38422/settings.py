"""
Django settings for bargo_shop_38422 project.
...
ROOT_URLCONF = 'bargo_shop_38422.urls'
...
WSGI_APPLICATION = 'bargo_shop_38422.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "bargo_shop_38422 API",
    "DESCRIPTION": "API documentation for bargo_shop_38422 App",
    "VERSION": "v1",
}
